...
require('lazy').setup({
  ...
  --
  require 'plugins.basic.lint',
  require 'plugins.basic.autopairs',
  require 'plugins.basic.neo-tree',
  require 'plugins.basic.nvim-window-picker',
  require 'plugins.basic.bmessage',
  require 'plugins.basic.gitsigns', -- adds gitsigns recommend keymaps

  require 'plugins.viewing.indent_line',
  require 'plugins.viewing.cursor_animation',
  require 'plugins.viewing.render_markdown',

  require 'plugins.debugger',
  -- require 'plugins.debugger.c',
  -- require 'plugins.debugger.python',

  require 'plugins.optional.neogit',
  require 'plugins.optional.spring-boot',
  -- require 'plugins.optional.distant',
  -- require 'plugins.optional.flutter',
  -- require 'plugins.optional.cscope',
